...
const CurrencyEContainer: React.FC<TProps> = props => {
    ...
    const changeCurrentCurrency = (e: React.MouseEvent<HTMLLIElement>) => {
        ...
        e.currentTarget.dataset.currency && ChangeCurrentCurrencyType(e.currentTarget.dataset.currency);
    };
...
//no need to create function for dispatching every AC, passing mDTProps directly
...
//             dispatch(ChangeCurrentCurrencyType(currency));
//         },
//     };
// };
...
const connector = connect(mapStateToProps, {
        ChangeActionAC,
        ChangeCurrencyFieldAC,
    ChangeCurrentCurrencyType: ChangeCurrentCurrencyAC,
    });
